...
// Define points
p0 = newp; Point(p0) = {0.5, 0.0, 1.0, 0.125 };
p1 = newp; Point(p1) = {0.5, 1.0, 1.0, 0.125 };
p2 = newp; Point(p2) = {0.5, 1.0, 0.0, 0.125 };
p3 = newp; Point(p3) = {0.5, 0.0, 0.0, 0.125 };
p4 = newp; Point(p4) = {0.0, 0.5, 0.0, 0.125 };
p5 = newp; Point(p5) = {0.0, 0.5, 1.0, 0.125 };
p6 = newp; Point(p6) = {1.0, 0.5, 1.0, 0.125 };
p7 = newp; Point(p7) = {1.0, 0.5, 0.0, 0.125 };
p8 = newp; Point(p8) = {0.0, 1.0, 0.5, 0.125 };
p9 = newp; Point(p9) = {0.0, 0.0, 0.5, 0.125 };
p10 = newp; Point(p10) = {1.0, 0.0, 0.5, 0.125 };
p11 = newp; Point(p11) = {1.0, 1.0, 0.5, 0.125 };
p12 = newp; Point(p12) = {0.75, 1.0, 0.5, 0.125 };
p13 = newp; Point(p13) = {0.75, 1.0, 1.0, 0.125 };
p14 = newp; Point(p14) = {0.75, 0.5, 1.0, 0.125 };
p15 = newp; Point(p15) = {0.75, 0.5, 0.5, 0.125 };
p16 = newp; Point(p16) = {1.0, 0.5, 0.75, 0.125 };
p17 = newp; Point(p17) = {1.0, 1.0, 0.75, 0.125 };
p18 = newp; Point(p18) = {0.5, 1.0, 0.75, 0.125 };
p19 = newp; Point(p19) = {0.5, 0.5, 0.75, 0.125 };
p20 = newp; Point(p20) = {0.5, 0.75, 1.0, 0.125 };
p21 = newp; Point(p21) = {1.0, 0.75, 1.0, 0.125 };
p22 = newp; Point(p22) = {1.0, 0.75, 0.5, 0.125 };
p23 = newp; Point(p23) = {0.5, 0.75, 0.5, 0.125 };
p24 = newp; Point(p24) = {0.5, 0.625, 0.5, 0.125 };
p25 = newp; Point(p25) = {0.75, 0.625, 0.5, 0.125 };
p26 = newp; Point(p26) = {0.75, 0.625, 0.75, 0.125 };
p27 = newp; Point(p27) = {0.5, 0.625, 0.75, 0.125 };
p28 = newp; Point(p28) = {0.625, 0.5, 0.75, 0.125 };
p29 = newp; Point(p29) = {0.625, 0.5, 0.5, 0.125 };
p30 = newp; Point(p30) = {0.625, 0.75, 0.5, 0.125 };
p31 = newp; Point(p31) = {0.625, 0.75, 0.75, 0.125 };
p32 = newp; Point(p32) = {0.5, 0.5, 0.625, 0.125 };
p33 = newp; Point(p33) = {0.75, 0.5, 0.625, 0.125 };
p34 = newp; Point(p34) = {0.75, 0.75, 0.625, 0.125 };
p35 = newp; Point(p35) = {0.5, 0.75, 0.625, 0.125 };
p36 = newp; Point(p36) = {0.0, 0.0, 1.0, 0.125 };
p37 = newp; Point(p37) = {0.0, 0.0, 0.0, 0.125 };
p38 = newp; Point(p38) = {0.0, 1.0, 0.0, 0.125 };
p39 = newp; Point(p39) = {0.0, 1.0, 1.0, 0.125 };
p40 = newp; Point(p40) = {1.0, 0.0, 1.0, 0.125 };
p41 = newp; Point(p41) = {1.0, 0.0, 0.0, 0.125 };
p42 = newp; Point(p42) = {1.0, 1.0, 0.0, 0.125 };
p43 = newp; Point(p43) = {1.0, 1.0, 1.0, 0.125 };
p44 = newp; Point(p44) = {0.5, 0.0, 0.5, 0.125 };
p45 = newp; Point(p45) = {0.5, 1.0, 0.5, 0.125 };
p46 = newp; Point(p46) = {0.5, 0.5, 1.0, 0.125 };
p47 = newp; Point(p47) = {0.5, 0.5, 0.0, 0.125 };
p48 = newp; Point(p48) = {0.0, 0.5, 0.5, 0.125 };
p49 = newp; Point(p49) = {1.0, 0.5, 0.5, 0.125 };
p50 = newp; Point(p50) = {0.75, 0.75, 1.0, 0.125 };
p51 = newp; Point(p51) = {0.75, 0.75, 0.5, 0.125 };
p52 = newp; Point(p52) = {0.75, 1.0, 0.75, 0.125 };
p53 = newp; Point(p53) = {0.75, 0.5, 0.75, 0.125 };
p54 = newp; Point(p54) = {1.0, 0.75, 0.75, 0.125 };
p55 = newp; Point(p55) = {0.5, 0.75, 0.75, 0.125 };
p56 = newp; Point(p56) = {0.625, 0.625, 0.5, 0.125 };
p57 = newp; Point(p57) = {0.625, 0.625, 0.75, 0.125 };
p58 = newp; Point(p58) = {0.75, 0.625, 0.625, 0.125 };
p59 = newp; Point(p59) = {0.5, 0.625, 0.625, 0.125 };
p60 = newp; Point(p60) = {0.625, 0.5, 0.625, 0.125 };
p61 = newp; Point(p61) = {0.625, 0.75, 0.625, 0.125 };
p62 = newp; Point(p62) = {0.5, 0.5, 0.5, 0.125 };
p63 = newp; Point(p63) = {0.75, 0.75, 0.75, 0.125 };
p64 = newp; Point(p64) = {0.625, 0.625, 0.625, 0.125 };
